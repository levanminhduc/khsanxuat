                            ...
                            <tbody id="default_settings_tbody">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr id="ds_row_<?php echo $row['id']; ?>">
                                        ...
                                        <td>
                                            <select id="ds_nguoi_chiu_trachnhiem_<?php echo $row['id']; ?>" class="form-control" style="width: 100%; height: 40px; white-space: normal;">
...
select[name^="nguoi_thuchien_"] {
    ...
    border-radius: 3px;
    font-size: 13px;
    height: 40px; /* Tăng chiều cao từ 30px lên 40px */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resetTimestamp && tieuchiReset && khsanxuatId && deptStored) {
        ...
        const currentDept = '<?php echo $dept; ?>';
