        <!-- Modal thêm tiêu chí -->
        <div id="addCriteriaModal" class="modal add-criteria-modal score-options-modal indexdept-modern-modal tw-fixed tw-inset-0 tw-z-[10000] tw-hidden tw-items-center tw-justify-center tw-overflow-y-auto tw-bg-slate-950/55 tw-p-3 tw-backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="add-criteria-title" hidden>
            <div class="modal-content add-criteria-modal__content score-options-modal__content tw-relative tw-m-0 tw-w-full tw-max-w-xl tw-overflow-hidden tw-rounded-lg tw-border tw-border-white/70 tw-bg-white tw-p-0 tw-shadow-modal-soft">
                ...
                <div class="add-criteria-modal__header score-options-modal__header tw-border-b tw-border-slate-200 tw-bg-slate-50 tw-px-4 tw-py-3">
                    <div class="tw-flex tw-items-start tw-justify-between tw-gap-4">
                        <div class="score-options-modal__heading tw-flex tw-min-w-0 tw-items-start tw-gap-3">
                            ...
                            <div class="tw-min-w-0">
                                <span class="score-options-modal__eyebrow tw-text-xs tw-font-bold tw-text-[#143583]">Tiêu chí</span>
                                <h3 id="add-criteria-title" class="modal-title add-criteria-modal__title score-options-modal__title tw-m-0 tw-pr-10 tw-text-xl tw-font-bold tw-leading-tight tw-text-slate-950">
                                    Thêm tiêu chí mới
                                </h3>
                            </div>
                        </div>
                ...
                <div class="add-criteria-modal__body score-options-modal__body tw-px-4 tw-py-4">
                    <form action="add_criteria.php" method="POST" class="add-criteria-modal__form tw-space-y-3">
                        ...
                        <div class="tw-grid tw-grid-cols-1 tw-gap-3 sm:tw-grid-cols-[120px_1fr]">
                            <div class="form-group add-criteria-modal__group add-criteria-modal__group--sm">
                                <label for="thutu" class="add-criteria-modal__label tw-mb-1 tw-block tw-text-xs tw-font-bold tw-text-slate-700">Thứ tự</label>
                                <input type="number" id="thutu" name="thutu" required min="1" class="form-control add-criteria-modal__control tw-h-9 tw-rounded-md tw-border-slate-300 tw-bg-white tw-text-slate-900 tw-shadow-sm focus:tw-border-[#143583] focus:tw-ring-2 focus:tw-ring-[#143583]/15" placeholder="1">
                            </div>

                            <div class="form-group add-criteria-modal__group">
                                <label for="noidung" class="add-criteria-modal__label tw-mb-1 tw-block tw-text-xs tw-font-bold tw-text-slate-700">Nội dung tiêu chí</label>
                                <textarea id="noidung" name="noidung" required rows="4" class="form-control add-criteria-modal__control add-criteria-modal__textarea tw-min-h-28 tw-rounded-md tw-border-slate-300 tw-bg-white tw-text-slate-900 tw-shadow-sm focus:tw-border-[#143583] focus:tw-ring-2 focus:tw-ring-[#143583]/15" placeholder="Nhập nội dung tiêu chí..."></textarea>
                            </div>
                        </div>

                        <div class="add-criteria-modal__actions tw-flex tw-flex-col-reverse tw-gap-2 tw-border-t tw-border-slate-100 tw-pt-3 sm:tw-flex-row sm:tw-justify-end">
                            <button type="button" onclick="closeModal()" class="btn-add-criteria score-options-modal__btn score-options-modal__btn--secondary add-criteria-modal__btn tw-inline-flex tw-h-9 tw-items-center tw-justify-center tw-rounded-md tw-border tw-border-slate-300 tw-bg-white tw-px-3 tw-text-sm tw-font-bold tw-text-slate-700 tw-shadow-sm tw-transition hover:tw-bg-slate-50">Hủy</button>
