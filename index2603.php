...
<body>
    ...
    <div class="navbar">
        <div class="navbar-left">
            <a href="index.php"><img src="img/logoht.png" alt="Logo"></a>
        </div>
    ...
    <div class="navbar-dropdown" id="navbar-dropdown">
        <div class="dropdown-search-container">
            <form class="search-form" action="" method="GET">
                <input type="hidden" name="month" value="<?php echo $selected_month; ?>">
                <input type="hidden" name="year" value="<?php echo $selected_year; ?>">
                <input type="text" name="search_xuong" placeholder="Tìm kiếm theo xưởng..." value="<?php echo isset($_GET['search_xuong']) ? htmlspecialchars($_GET['search_xuong']) : ''; ?>">
                <button type="submit" class="search-button">🔍</button>
            </form>
        </div>
            ...
            <div class="eval-content">
                ...
                <p>
                    <?php foreach ($best_dept_names as $index => $dept): ?>
                        <strong>
                            <a href="dept_statistics.php?dept=<?php echo array_search($dept, array_keys($chart_departments)); ?>&month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" style="color: inherit; text-decoration: underline;">
                                <?php echo $dept; ?>
                            </a>
                        </strong>
