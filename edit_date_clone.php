                ...
                <form method="post" action="" id="date_form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="new_qty" id="qty_input" class="form-input"
                                value="<?php echo $item_data['qty']; ?>" min="1" step="1" required>
                        </div>

                        <div class="form-group">
                            <label for="line_input" class="form-label form-label-required">Line (1-10):</label>
                            <input type="number" name="new_line" id="line_input" class="form-input"
                                value="<?php echo htmlspecialchars($item_data['line1']); ?>" placeholder="1-10" min="1"
